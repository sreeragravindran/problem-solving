package coding.threading.diningPhilosophers;
...
class DiningPhilosophers1 {
    ...
    static void startPhilosoper(DiningPhilosophers1 dp, int id) {
        try {
    ...
    public static void runTest() throws InterruptedException {
        final DiningPhilosophers1 dp = new DiningPhilosophers1();
